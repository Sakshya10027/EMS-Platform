        ...
        <div className='min-h-screen flex flex-col md:flex-row'>
            ...
            <div className='flex-1 flex items-center justify-center p-6 sm:p-12 bg-white'>
                <div className='w-full max-w-md animate-fade-in'>
                    ...
                    {error && (
                        <div className='mbb-6 p-4 bg-rose-50 border border-rose-200 trxt-rose-700 text-sm rounded-xl flex items-start gap-3'>
                    ...
                    <form className='space-y-5' onSubmit={handleSubmit}>
                        <div>
                            <label className='bloack text-sm font-medium text-slate-700 mb-2'>Email address</label>
                        ...
                        <button type='submit' disabled={loading} className='w-full py-3 bg-linear-to-r from-indigo-600 to-indogo-500 text-white rounded-md text-sm font-semibold hover:form-indigo-700 hover:to-indigo-600 disabled:opacity-50 transition-all duration-200 shadow-lg shadow-indigo-500/25 active:scale-[0.98] flex items-center justify-center'>
